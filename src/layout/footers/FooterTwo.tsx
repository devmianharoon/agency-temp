                ...
                <div className="footer-wrapper footer-2-wrapper mb-30">
                  ...
                  <div className="footer-text ">
                    <p>
                      ...
                      apereaque ipsa quae ab illo inventore veritatis et quasi
              ...
              <div className="row">
                <div className="col-xl-8 col-lg-8 col-md-8">
                  <div className="copyright">
                    <p>
                      ...
                      <Link href="#">Torun</Link>. All rights reserved.
                    </p>
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-4">
                  <div className="footer-bottem-text text-md-right">
                    <p>
                      Design By <Link href="#">BDevs</Link>
                    </p>
                  </div>
                </div>
              </div>
